...
const writeEnvFile = async (config, endpointName = "bitly_auth") => {
...
const toRuntimeJson = (answers, currentConfig) => {
    ...
    const production = {
        ...
        baseUri: answers.baseUriProd ||
            ((_a = currentConfig === null || currentConfig === void 0 ? void 0 : currentConfig.production) === null || _a === void 0 ? void 0 : _a.baseUri) ||
            "http://localhost:5000",
        firebaseProjectId: throwIfUndefined(answers.firebaseProjectIdProd ||
            ((_b = currentConfig === null || currentConfig === void 0 ? void 0 : currentConfig.production) === null || _b === void 0 ? void 0 : _b.firebaseProjectId)),
        ...
        bitlyClientSecret: throwIfUndefined(answers.bitlyClientSecretProd ||
            ((_e = currentConfig === null || currentConfig === void 0 ? void 0 : currentConfig.production) === null || _e === void 0 ? void 0 : _e.bitlyClientSecret)),
    };
    const staging = {
        ...
        baseUri: answers.baseUriStaging ||
            ((_f = currentConfig === null || currentConfig === void 0 ? void 0 : currentConfig.staging) === null || _f === void 0 ? void 0 : _f.baseUri) ||
            "http://localhost:5000",
        firebaseProjectId: throwIfUndefined(answers.firebaseProjectIdStaging ||
            ((_g = currentConfig === null || currentConfig === void 0 ? void 0 : currentConfig.staging) === null || _g === void 0 ? void 0 : _g.firebaseProjectId)),
