...
exports.ensureFirebaseLoginStatus = ensureFirebaseLoginStatus;
const ensureFirebaseFunctionsConfig = async (environment, config) => {
...
exports.ensureFirebaseFunctionsConfig = ensureFirebaseFunctionsConfig;
const deployFunctions = async (args) => {
